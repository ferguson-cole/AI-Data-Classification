"""
 ...
 and taken turns at the keyboard for the majority of the work that we are submitting. Furthermore, any non programming 
 portions of the assignment were done independently. We recognize that should this not be the case, we will be subject 
 to penalties as outlined in the course syllabus.

Pair Programmer 1 (print & sign your name, then date it)
Cole Ferguson, 11/17/2020

Pair Programmer 2 (print & sign your name, then date it) 
Ryan Hildebrant, 11/17/2020
"""
import time
